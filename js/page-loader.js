  ...
  <main>
      ...
      <div class="container service-hero__grid">
        <div class="service-hero__copy">
          ...
          <nav class="service-breadcrumb" aria-label="Breadcrumb">
            <a href="index.html">Home</a><span>/</span><a href="services.html">Services</a><span>/</span><span data-service-title></span>
          </nav>
        </div>
      </div>
    </section>
    <section class="section">
      <div class="container content-grid">
        <aside class="sticky-note"><h3>Is this right for your floor?</h3><p data-service-short></p><a class="btn" href="contact.html">Request Review</a></aside>
        <div class="info-stack">
          <section class="info-block"><h2>What this means for your home</h2><p data-service-intro></p></section>
          <figure class="service-visual"><img data-service-image src="" alt="" loading="lazy"><figcaption><strong data-service-title></strong><span data-service-short></span></figcaption></figure>
          <section class="info-block"><h2>What we take care of</h2><ul class="detail-list" data-service-included></ul></section>
          <section class="info-block"><h2>Materials you can choose from</h2><ul class="material-list" data-service-materials></ul></section>
          <section class="info-block"><h2>When this is a good fit</h2><ul class="check-list" data-service-situations></ul></section>
          <section class="info-block"><h2>How the work usually goes</h2><ol class="number-list" data-service-process></ol></section>
          <section class="info-block"><h2>Small details that matter</h2><ul class="check-list" data-service-details></ul></section>
          <section class="info-block"><h2>Things people usually ask</h2><div class="faq-list" data-service-faq></div></section>
        </div>
      </div>
    </section>
    <section class="section category-band">
      <div class="container"><p class="eyebrow">Related services</p><h2>Other flooring work to consider.</h2><div class="services-grid related-services" data-related-services></div></div>
    </section>
    <section class="section service-detail-cta-section">
      <div class="container service-detail-cta">
        <div>
          <p class="eyebrow">Next step</p>
          <h2>Need help deciding if this service fits your floor?</h2>
    ...
    <div class="container footer-grid">
      <div><a class="brand" href="index.html"><span class="brand-mark"></span><span data-company-name></span></a><p data-footer-text-primary></p></div>
      <div><h3>Services</h3><div class="footer-links" data-services-nav></div></div>
...
["site-config.js", "services-data.js", "main.js"].forEach((file) => {
  const script = document.createElement("script");
  script.src = `js/${file}?v=${assetVersion}`;
  script.async = false;
